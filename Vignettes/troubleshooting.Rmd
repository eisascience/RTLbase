...
- Ensure core dependencies are installed: `install.packages(c("caret", "data.table",
  "e1071", "ggplot2", "RColorBrewer", "DescTools", "zoo"))`.
- Optional packages for specialized features: `install.packages(c("GSE", "gradDescent"))`.
  Note: These packages may not be available on CRAN. They are only required for
  specific functions like `SpecializedGD2D()`.
